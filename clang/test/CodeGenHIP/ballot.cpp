...
// RUN: %clang_cc1 -triple amdgpu9.00-amd-amdhsa -fenable-new-pm-codegen -aux-triple x86_64-pc-windows-msvc -x hip -S -fcuda-is-device -o - %s | FileCheck %s --check-prefix=GFX9
